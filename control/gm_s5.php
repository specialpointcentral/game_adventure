    ...
    <div class="row">
        ...
        <div class="span6">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="./gm_s5.php">Completed</a></li>
            </ul>
            <div class="panel panel-primary" style="margin-top: 20px">
                <div class="panel-heading">
                    <h3 class="panel-title">已完成所有任务的用户</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-hover table-responsive">
                        ...
                        $sql = "SELECT user_idnum  , time_last FROM game_user WHERE user_identifykey = 'over' ";
