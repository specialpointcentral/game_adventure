    ...
    <div class="row">
        ...
        <div class="span6">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="./gm_s4.php">Step4</a></li>
                <li><a href="./gm_s5.php">Completed</a></li>
            </ul>
            <div class="panel panel-primary" style="margin-top: 20px">
                <div class="panel-heading">
                    <h3 class="panel-title">进行到步骤四的用户</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-hover table-responsive">
                        ...
                        $sql = "SELECT user_idnum , user_key4 , time_4 FROM game_user WHERE user_key4 <> '' ";
                        ...
                        if ($retval)
                        {
                            ...
                            while ($row = mysql_fetch_assoc($retval))
                            {
                                ...
                                echo "<td>". $row['user_key4'] . "</td>";
                                echo "<td>". $row['time_4'] . "</td>";
                                echo "</tr>";
                            }
                        }
                        mysql_close($conn);
